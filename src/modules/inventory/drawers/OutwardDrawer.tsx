...
interface OutwardDrawerProps {
  form?: any; // Optional form instance if controlled from parent
}

const OutwardDrawer: React.FC<OutwardDrawerProps> = ({ form }) => {
  const [items, setItems] = useState<any[]>([]);

  // Sample items for selection
  const inventoryItems = [
    { id: '1', code: 'FAB001', name: 'Cotton Fabric', category: 'Raw Materials', unit: 'meters', availableQty: 500 },
    { id: '2', code: 'FAB002', name: 'Polyester Fabric', category: 'Raw Materials', unit: 'meters', availableQty: 350 },
    { id: '3', code: 'YRN001', name: 'Cotton Yarn', category: 'Raw Materials', unit: 'kg', availableQty: 200 },
    { id: '4', code: 'BTN001', name: 'Plastic Buttons', category: 'Accessories', unit: 'pcs', availableQty: 1000 },
    { id: '5', code: 'ZIP001', name: 'Metal Zippers', category: 'Accessories', unit: 'pcs', availableQty: 750 },
  ];
  ...
  return (
    <Form layout="vertical" form={form}>
      <Row gutter={16}>
        <Col span={8}>
          <Form.Item name="outwardNumber" label="Outward Number" rules={[{ required: true, message: 'Please enter outward number' }]}>
            <Input placeholder="Outward Number" />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item name="outwardDate" label="Outward Date" rules={[{ required: true, message: 'Please select date' }]}>
            <DatePicker style={{ width: '100%' }} />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item name="outwardType" label="Outward Type" rules={[{ required: true, message: 'Please select type' }]}>
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item name="customer" label="Customer/Recipient">
            <Select placeholder="Select customer" allowClear showSearch>
              <Option value="customer1">Fashion Trends Ltd.</Option>
              <Option value="customer2">Apparel Creations Inc.</Option>
              <Option value="customer3">Garment Exports Co.</Option>
              <Option value="customer4">Clothing Manufacturers Ltd.</Option>
              <Option value="customer5">Style Makers International</Option>
            </Select>
          </Form.Item>
        </Col>
        <Col span={12}>
          <Form.Item name="referenceNumber" label="Reference Number">
            <Input placeholder="SO/Invoice Number" />
          </Form.Item>
        </Col>
      </Row>
        ...
        <Col span={24}>
          ...
          >
            <Upload.Dragger name="files" action="/upload.do" listType="picture" maxCount={3}>
              ...
              <p className="ant-upload-hint">Support for delivery challan, gate pass, etc. Max 3 files.</p>
            </Upload.Dragger>
          </Form.Item>
        </Col>
      </Row>
